...
dt <- readRDS("C:/OneDrive/data/county_coexistence_panel_Dec19_v6.rds")
setDT(dt)
...
# -----------------------------------------------------------------------------
county_demo_data <- readRDS("C:/OneDrive/data/county_demo_data.rds")
...
# -----------------------------------------------------------------------------
sod_data <- readRDS("C:/OneDrive/data/fdic_sod_2000_2025_simple.rds")
