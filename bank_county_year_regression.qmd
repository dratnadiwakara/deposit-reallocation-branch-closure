...
p05_growth <- reg_base[, quantile(growth_on_total_t3, probs = 0.05, na.rm = TRUE)]
reg_base[growth_on_total_t3 < p05_growth, growth_on_total_t3 := p05_growth]
p95_growth <- reg_base[, quantile(growth_on_total_t3, probs = 0.95, na.rm = TRUE)]
reg_base[growth_on_total_t3 > p95_growth, growth_on_total_t3 := p95_growth]


p05_growth <- reg_base[, quantile(growth_on_total_t1, probs = 0.05, na.rm = TRUE)]
reg_base[growth_on_total_t1 < p05_growth, growth_on_total_t1 := p05_growth]
p95_growth <- reg_base[, quantile(growth_on_total_t1, probs = 0.95, na.rm = TRUE)]
...
desc_stats <- reg_main[!is.na(period), .(
  N = .N,
  depvar_mean = round(mean(growth_on_total_t1, na.rm = TRUE), 4),
  depvar_sd   = round(sd(growth_on_total_t1, na.rm = TRUE), 4),
  depvar_min  = round(min(growth_on_total_t1, na.rm = TRUE), 4),
  depvar_max  = round(max(growth_on_total_t1, na.rm = TRUE), 4),
  closure_share_mean = round(mean(closure_share, na.rm = TRUE), 4),
  closure_share_sd   = round(sd(closure_share, na.rm = TRUE), 4),
  closure_share_min  = round(min(closure_share, na.rm = TRUE), 4),
  closure_share_max  = round(max(closure_share, na.rm = TRUE), 4)
